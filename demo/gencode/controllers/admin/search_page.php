...
class Search_page extends Admin_Controller {
	...
	public function index()
	{
		...
		$this->template->display('search_page.html');	
	}
	...
	public function field()
	{
		...
		$this->template->display('search_field.html');	
	}
	...
	public function base()
	{
		...
		$this->template->display('search_base.html');	
	}
